...
public class ItemHandlerExternalPatternProviderInputSinkFactory
    ...
    public PatternProviderExternalPatternInputSink create(final ServerLevel level,
        ...
        return new ItemHandlerExternalPatternProviderInputSink(new CapabilityCacheImpl(level, pos, direction));
    }
}
